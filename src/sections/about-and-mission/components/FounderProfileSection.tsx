        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          ...
          <div className="lg:w-[380px] shrink-0">
            <div className="rounded-2xl backdrop-blur-xl border border-white/20 dark:border-white/10 bg-white/60 dark:bg-slate-900/60 shadow-[0_8px_40px_rgba(59,130,246,0.08)] dark:shadow-[0_8px_40px_rgba(59,130,246,0.04)] p-8 text-center">
              ...
              <GlassPill as="div" className="w-28 h-28 mx-auto mb-6 rounded-full bg-gradient-to-br from-blue-100 to-slate-200 dark:from-blue-900 dark:to-slate-800 border-4 border-white/30 dark:border-white/10 shadow-[0_8px_32px_rgba(59,130,246,0.12)] flex items-center justify-center" options={{ refraction: 0.01, bevelDepth: 0.06, bevelWidth: 0.14, specular: true, shadow: true }} aria-label={`Photo of ${profile.name}`}>
