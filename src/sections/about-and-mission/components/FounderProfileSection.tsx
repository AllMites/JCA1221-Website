          ...
          <div className="flex-1 space-y-12">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {profile.quotes.map((q, i) => (
                <div
                  key={i}
                  className="rounded-xl backdrop-blur-lg border border-white/20 dark:border-white/10 bg-white/50 dark:bg-slate-900/50 shadow-[0_4px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-5 flex flex-col"
                >
