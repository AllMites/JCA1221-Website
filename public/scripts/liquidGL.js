    ...
    _initGL() {
      ...
      const fsSource = `
        ...
        void main(){
          ...
          // Fix: udRoundBox returns 0 for all inside points when radius=0
          // (max(negative, 0) clips to 0). step(0,0)=1 → inShape=0 incorrectly.
          // Use a small epsilon so inside/edge points count as in-shape.
          float inShape = 1.0 - step(0.001, dmask);
