# JCA 1221 Holdings — Design Handoff

This folder contains everything needed to implement the JCA 1221 Holdings website.
...
- **Secondary:** amber — tags, highlights, comparison tint
- **Neutral:** slate — backgrounds, text, borders
- **Heading font:** DM Sans
- **Body font:** Inter
- **Mono font:** IBM Plex Mono
- **Glassmorphism:** backdrop-blur-xl, bg-white/N/5-70, border border-white/10-20, colored shadows
- **Neumorphism:** rounded-full pills with offset light+dark shadows, inset active state
- **CTA buttons:** glass-tinted bg-blue-500/80 + backdrop-blur-md + rounded-full + blue glow shadow
